		...
		<div class="login_cont">
				...
				<div class="admin_right">
					 ...
					 <div class="table_r"  style="display: block; height:800px; overflow-y:scroll;">
						 <h2 align="center">Shop management</h2>
						 ...
						 <div class="btn-group" style="margin: 10px;">
						   ...
						   <ul class="dropdown-menu">
						     <li><a href="addshop.jsp">Add</a></li>
						     ...
						     <%
                                                        ...
                                                        Statement statement = one.createStatement();//获取操作数据库的对象
                                                            ...
                                                            while(resultSet.next()){ //遍历结果集，取出数据
                                                             ...
                                                             out.println("<td>"+classes+"</td>");
                                                             out.println("<td>"+phone+"</td>");
                                                             out.println("<td><a href='seditone.jsp?id="+sid+"'>edit</a></td>");
                                                             out.println("<td><a href='../../DeleteShop?id="+sid+"'>delete</a></td>");
