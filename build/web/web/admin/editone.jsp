					 ...
					 <div class="table_r">
						 ...
						 <div class="btn-group" style="margin: 10px;">
						   <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						     Edit User <span class="caret"></span>
						   </button>
						   <ul class="dropdown-menu">
						     <li><a href="indexs.html">Edit</a></li>
							 ...
							 <form action="../../UpdateOne" method="post">
                                                        ...
                                                        String id= request.getParameter("id");
                                                            ...
                                                            while(resultSet.next()){ //遍历结果集，取出数据
                                                              ...
                                                              out.println("<input type='email' class='form-control' id='exampleInputEmail1' name='email' value='"+email+"'/>");
                                                              out.println("</div>");
                                                              ...
                                                              out.println("<input type='text' class='form-control' id='exampleInputEmail1' name='username' placeholder='Username' value='"+username+"'>");
                                                              out.println("</div>");
                                                              
                                                              out.println("<div class='form-group'>");
                                                              out.println("<label for='exampleInputPassword1'>Password</label>");
                                                              out.println(" <input type='password' class='form-control' id='exampleInputPassword1' name='password' placeholder='Password' value='"+password+"'>");
                                                              out.println("</div>");
                                                                
                                                              out.println("<div class='form-group'>");
                                                              out.println("<label for='exampleInputPassword1'>Phone</label>");
                                                              out.println("  <input type='text' class='form-control' id='exampleInputPassword1' name='phone' placeholder='Phone'value='"+phone+"'>");
                                                              out.println("</div>");
                                                                
                                                                 out.println("  <input type='hidden'  name='uid' value='"+userid+"'>");
                                                           
                                                              out.println("<button type='submit' class='btn btn-default'>Add User</button>");
