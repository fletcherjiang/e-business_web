			...
			<h3>热卖单品</h3>
                        ...
                        <jsp:useBean id="test" class="conns.ConnSql"/>
						    <%
		                                            ...
		                                            request.setCharacterEncoding("utf-8");
                                                            ...
                                                            String sql="select * from commodity where title like '%"+keyword+"%'";
                ...
                <div class="contshopbt hidden-lg">
						    ...
						    <%
                                                          ...
                                                          String sqls="select * from commodity where title like '%"+keyword+"%'";
                                                            ...
                                                            while(resultSets.next()){ //遍历结果集，取出数据
                                                              ...
                                                              // out.println(test_name);
                                                             out.println("<li>");
                                                             out.println("<a href='content.jsp?id="+sids+"' target=''>");
