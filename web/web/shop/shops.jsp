...
<html>
	<head>
		...
		<script>
			$(function(){
				//alert($(document).width()-300);
				$(".login_cont").height($(document).height());
						    ...
						    <%
                                                        ...
                                                        Statement statement = one.createStatement();//获取操作数据库的对象
                                                         Object shopid=request.getSession().getAttribute("shop");
                                                            String sql="select * from commodity where shopid='"+shopid+"'";
                                                            ...
                                                            while(resultSet.next()){ //遍历结果集，取出数据
                                                             ...
                                                             out.println("<td><a href='../../DeleteShopss?id="+sid+"'>delete</a></td>");
